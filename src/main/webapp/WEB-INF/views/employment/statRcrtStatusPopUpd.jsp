...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/employment/statRcrtStatusPopUpd.js"></script>
<style>
...
/* 그리드의 selectbox의 위치를 가운데로 조절 해주기 위해서 추가함. 태그는 브라우저 디버깅 기능 이용해서 확인 가능 하다. */
